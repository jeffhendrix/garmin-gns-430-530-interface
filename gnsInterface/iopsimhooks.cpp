...
#define IOP_REGISTER3e8 (0x3e8)
#define IOP_REGISTER3f8 (0x3f8) // 4
#define IOP_REGISTER412 (0x412) // 10
#define IOP_REGISTER413 (0x413)
#define IOP_REGISTER414 (0x414) // 1
#define IOP_REGISTER417 (0x417) // seen lots
#define IOP_REGISTER419 (0x419) // 4
#define IOP_REGISTER422 (0x422) // 10
#define IOP_REGISTER7f0 (0x7f0) // 4
#define IOP_REGISTER7f2 (0x7f2) // 4
...
//        logMessageEx("--- IopSimHooks::TSK_pvg_send_msg_ex msg_type %08x", msg_type);
        ...
        if(0 == msg_type)
        {
			...
			logMessageEx("--- IopSimHooks::TSK_pvg_send_msg_ex hfom=%x, vfom=%x, uk1=%x, uk2=%x, uk3=%x, uk4=%x",
				pmsg->hfom, pmsg->vfom, pmsg->unknown1, pmsg->unknown2, pmsg->unknown3, pmsg->unknown4);
#endif
